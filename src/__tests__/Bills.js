  ...
  describe("When I am on Bills Page", () => {
    ...
    test("Then getBills should throw an error when failing to fetch bills", async () => {
      ...
      const mockedStore = {
        bills() {
          return {
            list: jest.fn().mockRejectedValue(error) // Configurer list pour renvoyer une promesse rejetée avec l'erreur spécifiée
          };
        }
      };
      ...
      // Vérifier que la méthode getBills génère une erreur lorsque la récupération des factures échoue
